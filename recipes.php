				...
				<div id="content">
					<div>
						<ul>
							...
							$query ="select r.rid, r.rtitle, rp.pname from recipe r left join recipepicture rp on (r.rid = rp.rid)";
							...
							?>
							 ...
							 <div class ="h" align="center">
							           <?php 
							            ...
							            {
							                  echo"<p onclick=\"window.location.href='recipeinfo.php?rid=".$row[0]."' \"> Recipe Title : ".$row[1]."</p>";
